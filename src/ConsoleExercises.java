...
public class ConsoleExercises {
    public static void main (String[] args){
        ...
        // question 1
        double pi =3.14159;
        // to format only two decimals to appear = .2f
        System.out.printf("The value of pi is approximately %.2f", pi);
        // System.out.format("The value of pi is approximately %.2f", pi);

        // scanner exercises
        // question 1 - error if string is entered instead of an int
        ...
        System.out.printf("The three words are: %s, %s, and %s.", wordCaptureOne, wordCaptureTwo, wordCaptureThree );
...
//
          ...
          // examples in additional reading
